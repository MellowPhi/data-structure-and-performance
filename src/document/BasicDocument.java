...
public class BasicDocument extends Document 
{
	...
	public int getNumSyllables()
	{
		...
		List<String>tokenWords = getTokens("[a-zA-Z]+");
...
//		BasicDocument bd = new BasicDocument("Obvious");
//		int syll = bd.countSyllables(bd.getText());
//		System.out.println("Number of syllables in " + bd.getText() + " is " + syll);
